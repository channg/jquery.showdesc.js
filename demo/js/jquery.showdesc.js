			...
			$(this).mouseover(function(){
				...
				if($(".desc_54556")[0]==null){
					...
					if(_flage=="right"){
						...
						var innner_div='<div id="desc_inn_3354" style="left:'+(jiantou_space+jiantou_width)+'px;min-width:'+data.width+'px;min-height:'+data.height+'px;border:'+data.borderWidth+'px solid '+data.borderColor+';position:absolute;top:0;background-color:'+data.backgroundColor+';border-radius:'+border_radius+'px"><div style="position:absolute;top:0;z-index:100">'+data.content+'</div></div>';
						...
						top= top-data.height;
						var jiantou_top =data.height/2-jiantou_width;
						var innner_div='<div id="desc_inn_3354" style="top:'+(-(jiantou_space+10))+'px;min-width:'+data.width+'px;min-height:'+data.height+'px;border:'+data.borderWidth+'px solid '+data.borderColor+';position:absolute;background-color:'+data.backgroundColor+';border-radius:'+border_radius+'px"><div style="position:absolute;top:0;z-index:100;min-width:'+data.width+'px;min-height:'+data.height+'">'+data.content+'</div></div>';
						var jiantou_1='<div style="width:0; height:0;border-left:'+jiantou_width+'px solid transparent;border-right:'+jiantou_width+'px solid transparent;border-top:'+jiantou_width+'px solid '+data.borderColor+';position:absolute;left:'+(data.width/2-data.arrowLenght)+'px;top:'+((data.height-jiantou_space+data.borderWidth-10))+'px;"></div>';
						var jiantou_2='<div style="width:0; height:0;border-left:'+jiantou_width+'px solid transparent;border-right:'+jiantou_width+'px solid transparent;border-top:'+jiantou_width+'px solid '+data.backgroundColor+';z-index:100;position:absolute;left:'+(data.width/2-data.arrowLenght)+'px;top:'+((data.height-jiantou_space-10))+'px;"></div>'
						$('body').append('<div class="desc_54556" style=";position:absolute;top:'+top+'px;left:'+left+'px;">'+jiantou_1+jiantou_2+innner_div+'</div>')
						...
						var jiantou_top =data.height/2-jiantou_width;
						var innner_div='<div id="desc_inn_3354" style="right:'+(jiantou_space+data.arrowLenght)+'px;min-width:'+data.width+'px;min-height:'+data.height+'px;border:'+data.borderWidth+'px solid '+data.borderColor+';position:absolute;background-color:'+data.backgroundColor+';border-radius:'+border_radius+'px"><div style="position:absolute;top:0;z-index:100">'+data.content+'</div></div>';
						...
						top= top+$(this).height();
						var jiantou_top =data.height/2-jiantou_width;
						var innner_div='<div id="desc_inn_3354" style="top:'+(jiantou_space+data.arrowLenght)+'px;min-width:'+data.width+'px;min-height:'+data.height+'px;border:'+data.borderWidth+'px solid '+data.borderColor+';position:absolute;background-color:'+data.backgroundColor+';border-radius:'+border_radius+'px"><div style="position:absolute;top:0;z-index:100">'+data.content+'</div></div>';
