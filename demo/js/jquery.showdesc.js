			...
			$(this).mouseover(function(){
				...
				if($(".desc_54556")[0]==null){
					...
					if(_flage=="right"){
						...
						top= top-data.height;
						var jiantou_top =data.height/2-jiantou_width;
						var innner_div='<div id="desc_inn_3354" style="top:'+(-(jiantou_space+10))+'px;min-width:'+data.width+'px;min-height:'+data.height+'px;border:'+data.borderWidth+'px solid '+data.borderColor+';position:absolute;background-color:'+data.backgroundColor+';border-radius:'+border_radius+'px">'+data.content+'</div>';
